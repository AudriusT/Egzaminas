...
<html class="no-js h-100" lang="en">
  ...
  <body class="h-100">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="components-blog-posts.blade.php">
                  <i class="material-icons">vertical_split</i>
                  <span>Blog Posts</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="add-new-post.blade.php">
                  <i class="material-icons">note_add</i>
                  <span>Add New Post</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="form-components.blade.php">
              ...
              <li class="nav-item">
                <a class="nav-link " href="user-profile-lite.blade.php">
                  <i class="material-icons">person</i>
                  <span>User Profile</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="errors.blade.php">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
            ...
            <span class="copyright ml-auto my-auto mr-2">Copyright © 2018
              <a href="{!!asset('https://designrevision.com')!!}" rel="nofollow">DesignRevision</a>
            </span>
          </footer>
        </main>
      </div>
    ...
    <script src="{!!asset('https://unpkg.com/shards-ui@latest/dist/js/shards.min.js')!!}"></script>
    <script src="{!!asset('https://cdnjs.cloudflare.com/ajax/libs/Sharrre/2.0.1/jquery.sharrre.min.js')!!}"></script>
